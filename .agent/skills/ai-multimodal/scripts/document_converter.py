...
def find_api_key() -> Optional[str]:
    ...
    2. packages/spec/src/claude/skills/ai-multimodal/.env (skill-specific config)
    3. packages/spec/src/claude/skills/.env (shared skills config)
    4. packages/spec/src/claude/.env (Claude global config)
    """
    ...
    if load_dotenv:
        ...
        skill_dir = script_dir.parent  # packages/spec/src/claude/skills/ai-multimodal
        skills_dir = skill_dir.parent   # packages/spec/src/claude/skills
...
Default output: <project-root>/docs/assets/document-extraction.md
    ...
    parser.add_argument('--model', default='gemma-4-31b-it',
                       help='Gemini model to use (default: gemma-4-31b-it)')
